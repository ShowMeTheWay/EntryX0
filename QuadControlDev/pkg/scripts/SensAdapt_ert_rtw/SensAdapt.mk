...
MODEL                   = SensAdapt
MODULES                 = SensAdapt_data.c 
MAKEFILE                = SensAdapt.mk
...
MASTER_ANCHOR_DIR       = 
START_DIR               = D:\Beni\workspace\EntryX0\QuadControlDev\pkg\scripts
S_FUNCTIONS             = 
S_FUNCTIONS_LIB         = 
NUMST                   = 1
NCSTATES                = 0
...
GEN_SAMPLE_MAIN         = 1
TARGET_LANG_EXT         = c
MEX_OPT_FILE            = -f C:\Users\User\AppData\Roaming\MATHWO~1\MATLAB\R2013a\mexopts.bat
COMPUTER                = PCWIN64
...
MODELLIB                  = SensAdaptlib.lib
MODELREF_LINK_LIBS        = 
MODELREF_LINK_RSPFILE     = SensAdapt_ref.rsp
MODELREF_INC_PATH         = 
...
MATLAB_INCLUDES = $(MATLAB_INCLUDES);$(START_DIR)\SensAdapt_ert_rtw
