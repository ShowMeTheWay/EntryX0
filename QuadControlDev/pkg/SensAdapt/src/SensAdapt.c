...
void SensAdapt_step(void)
{
  ...
  /* Outputs for IfAction SubSystem: '<S7>/madgEstimator' incorporates:
   *  ActionPort: '<S18>/Action Port'
   */

  /* S-Function (madgwick_f): '<S18>/S-Function Builder1' */
  madgwick_f_Outputs_wrapper(&SensAdapt_B.Add, &SensAdapt_B.Add_g0zf,
    &SensAdapt_B.Add_p1ev, &SensAdapt_B.gyrox_data_in,
  ...
  SensAdapt_B.Merge[0] = SensAdapt_B.SFunctionBuilder1_o1;
  SensAdapt_B.Merge[1] = SensAdapt_B.SFunctionBuilder1_o2;
  SensAdapt_B.Merge[2] = SensAdapt_B.SFunctionBuilder1_o3;
  SensAdapt_B.Merge[3] = SensAdapt_B.SFunctionBuilder1_o4;
  SensAdapt_B.Merge[4] = 0.0;
  SensAdapt_B.Merge[5] = 0.0;
  SensAdapt_B.Merge[6] = 0.0;

  /* End of Outputs for SubSystem: '<S7>/madgEstimator' */
